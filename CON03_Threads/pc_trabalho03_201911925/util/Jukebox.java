...
public abstract class Jukebox {
  private static final String DIRETORYPATH = "pc_trabalho03_201911925/res/audio/"; // Diretorio dos audios
  ...
  public static void play(String fileName){
    try {
      ...
      if(audio.exists()){ // Verifico se a instancia foi bem sucedida
        ...
        clip.loop(Clip.LOOP_CONTINUOUSLY); // Defino um loop para que a musica nunca pare
